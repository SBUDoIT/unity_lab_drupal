...
<div class="container-fluid">
    ...
    <div class="row position-relative">
        ...
        <div class="hidden-xs col-md-6 side-image" data-background="https://farm4.staticflickr.com/3941/15487768325_4407b8140c_k_d.jpg"></div>

        <div class="col-xs-12 col-md-6 col-md-offset-6 side-image__text">

            <?php if($title): ?>
              <h2 class="font-alt section-themeable align-left no-padding">Test <?php print $title ?></h2>
            <?php endif; ?>
